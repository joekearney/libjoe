...
public class CircularArrayListTest extends TestCase {
	public static Test suite() {
		...
		testSuite.addTest(new TestSuite(CircularArrayListTest.class, "Custom tests"));
	...
	private static Test createCircularArrayListTestCase(final int offset) {
		return ListTestSuiteBuilder.using(new TestStringListGenerator() {
			...
			public List<String> create(String[] elements) {
				...
				.named(
						CircularArrayList.class.getSimpleName()
	...
	public static class ListIteratorTests extends TestCase {
		...
		public void testIterator$HasNextAddNextRemove() {
			List<String> list = new CircularArrayList<String>();
	...
	public static class InsertGapTests extends TestCase {
		public void testInsertGap$caseAHead() throws Exception {
			...
			runInsertTest(1, 4, list, expected, 1, 1);
		}
		...
		public void testInsertGap$caseAMiddleOneLength() throws Exception {
			List<String> list = asList(null, "a", "b", "c", null, null, null, null);
			List<String> expected = asList(null, "a", null, "b", "c", null, null, null);
		...
		public void testInsertGap$caseBOneLength() throws Exception {
			...
			List<String> expected = asList("c", null, null, null, null, "a", null, "b");
		...
		public void testInsertGap$caseDOneLength() throws Exception {
			...
			List<String> expected = asList("b", "c", null, null, null, null, "a", null);
		 ...
		 * @throws Exception
		 */
		private void runInsertTest(int head, int tail, List<String> list, List<String> expected,
			...
			List<Object> elements = asList((Object[]) Whitebox.getInternalState(adl, "elements"));
	...
	public static class DeleteRangeTests extends TestCase {
		...
		public void testDeleteRange$caseD$2() throws Exception {
			List<String> list = asList("e", "f", "g", "h", "i", "j", null, null, null, null, null,
					null, "a", "b", "c", "d");
			List<String> expected = asList("i", "j", null, null, null, null, null, null, null,
					null, null, null, "a", "b", "g", "h");
			
			runDeleteTest(12, 6, list, expected, 14, 4);
		}
		private void runDeleteTest(int head, int tail, List<String> list, List<String> expected,
				int gapIndex, int gapLength) throws Exception {
			CircularArrayList<Object> adl = createADL(head, tail, list.toArray());
	...
	private void removeFirstToDrain(CircularArrayList<Integer> list) {
		while (list.size() > 0) {
			list.removeFirst();
		}
	}
	private static Object[] getArray(CircularArrayList<?> list) {
